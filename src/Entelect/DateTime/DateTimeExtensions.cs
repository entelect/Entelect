...
namespace Entelect.Extensions
{
    ...
    public static class DateTimeExtensions
    {
        ...
        /// <exception cref="System.ArgumentException">If <paramref name="startDate"/> is after <paramref name="endDate"/></exception>
        public static int NumberOfBusinessDaysUntil(this DateTime startDate, DateTime endDate, params DateTime[] bankHolidays)
        {
